...
#import "SecondViewAppDelegate.h"

@implementation SecondViewAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    tableViewController = [[SecondViewController alloc] initWithStyle:UITableViewStylePlain];
